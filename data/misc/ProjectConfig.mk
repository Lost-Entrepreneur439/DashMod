...
CUSTOM_HAL_IMGSENSOR = hi553_mipi_raw gc2365_mipi_raw gc030A_mipi_raw gc0409_mipi_raw
CUSTOM_HAL_LENS = dummy_lens dummy_lens dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR = gc2365_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR = hi553_mipi_raw gc2365_mipi_raw gc030A_mipi_raw gc0409_mipi_raw
...
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR = gc2365_mipi_raw
...
CUSTOM_MODEM = b6580_we_a_m_hspa_5110DW_band125
...
MTK_BUILD_VERNO = alps-mp-m0.mp1-V2.34_b6580.weg.a.m
MTK_BWC_SUPPORT = yes
MTK_C2K_SUPPORT = no
...
#CREATE_PROJECT_INFO=20161110114233
BIRD_CUSTOM = 5110D
BIRD_DWS = WCDMA
BIRD_WITH_DEXPREOPT = yes

#---------------------- bird imgsensor ------------------------
BIRD_SUB_IMGSENSOR = gc0409_mipi_raw_5110DW_4080_AM_DS84_WVGA
BIRD_MAIN_IMGSENSOR = hi553_mipi_raw_5110D_Z5501A_Q_S
BIRD_MAIN_BACKUP_IMGSENSOR = gc2365_mipi_raw_5110DW_4080_AM_DS84_WVGA
BIRD_SUB_BACKUP_IMGSENSOR = gc030A_mipi_raw_5110DW_4080_AM_DS84_WVGA
BIRD_CAMERA_DEFAULT_PICTURE_RATIO=1.3333
BIRD_FIRST_LOGO = NUU_WVGA_LOGO
BIRD_SECOND_LOGO = NUU_WVGA_LOGO
BIRD_BOOT_ANIMATION = NUU_WVGA_BOOT_ANI
#BIRD_SHUTDOWN_ANIMATION = AD_FWVGA_SHUT_ANI
BIRD_BOOT_RING_ON = no
#BIRD_BOOT_RING = 
#BIRD_SHUTDOWN_RING = android_audio_SHUTDOWN
#BIRD_CUSTOM_BROWSER=yes
#BIRD_CUSTOM_BROWSER_CONFIG=
BIRD_WRITE_IMEI = yes
#BIRD_LOGO_NO_PERCENT = no
BIRD_TORCH = no
#BIRD_ADB_DEBUG = yes
BIRD_CTS_TEST = no
BIRD_HIDE_NOSIM_ICON = yes

BIRD_CUSTOM_RING_CFG = NUU

BIRD_DEFAULT_WALLPAPER = NUU_Z403_DEFAULT
BIRD_EXTRA_WALLPAPERS = NUU_Z403_WVGA

BIRD_TP_SMART_WAKE = 2
BIRD_TP_SMART_WAKE_QUICK_GESTURE = 1
BIRD_TP_SMART_WAKE_CONFIG=NUU_Z503
...
BIRD_PRODUCT_MODEL =NUU_A1
BIRD_PRODUCT_NAME = NUU_A1
BIRD_PRODUCT_DEVICE = NUU_A1
BIRD_PRODUCT_MANUFACTURER = NUU
#BIRD_BUILD_PRODUCT = 
BIRD_PRODUCT_BRAND=NUU
BIRD_BT_STRING=NUU_A1
#BIRD_MTP_LABEL= 
#BIRD_MTP_MODEL= 
#BIRD_MTP_MANUFACTURER=
#BIRD_PTP_MODEL=
BIRD_WLAN_DIRECT_NAME=NUU_A1   
BIRD_WLAN_SSID_STRING=NUU_A1

BUILD_GMS=yes
GOOGLE_LAUNCHER_FOR_NUU=no
#GOOGLE_GMS6.0 = yes
#BIRD_APK_FACEBOOK = yes
#BIRD_APK_GOOGLE_ZHUYIN_IME = yes
#BIRD_APK_GOOGLE_PINYIN_IME = yes
#GOOGLE_CHROME = yes
#GOOGLE_YOUTUBE = yes
#GOOGLE_MAIL = yes
#GOOGLE_MAPS = yes
#GOOGLE_QUICKSEARCHBOX = yes
#GOOGLE_PULS = yes
#GOOGLE_TALK = yes
#GOOGLE_TTS = yes
#GOOGLE_MUSIC = yes
#GOOGLE_VIDEO = yes
#GOOGLE_SETUPWIZARD = yes
#GOOGLE_FACELOCK = yes
BIRD_DEFAULT_DATE_FORMAT = 0
#GOOGLE_CALENDAR = yes
...
#BIRD_APK_GOOGLE_PINYIN_IME=yes
#BIRD_DEFAULT_INPUT_METHOD = com.android.inputmethod.latin/.LatinIME
#1 dd-MM-yyyy
#BIRD_DEFAULT_DATE_FORMAT = 2
#BIRD_EMAIL_SIGNATURE=yes
#BIRD_EMAIL_SIGNATURE_CONFIG=
BIRD_BATTERY_PERCENTAGE=yes
BIRD_HARDWARE_INFO=yes
BIRD_DEFAULT_TIME_FORMAT_24 = no
BIRD_DEFAULT_TIMEZONE = America/Chicago
#BIRD_SCTIME_OUT_NEVER=yes
BIRD_SETTINGS_DEVELOPMENT_DETAIL=yes
BIRD_CALENDAR_START_VIEW=month
#BIRD_FAKE_FOCUS=yes
BIRD_PROXIMITY_CALIBRATION=no
BIRD_GSENSOR_CALIBRATION=yes
BIRD_MEMORY_OPTIMIZATION=yes
BIRD_TP_SMART_WAKE_ANIMA_SMALL=yes
BIRD_DATA_DEFAULT_ON=yes
ADUPS_FOTA_SUPPORT=yes
BIRD_HIDE_STATUS_BAR_NETWORK_TYPE_ICON=yes
BIRD_MODIFY_MENU_PRESS=yes
BIRD_FUN_MIKEYBOARD=no
BIRD_GEMINI_DEFAULT_DATA_ON_ALWAYS=yes
BIRD_LOW_RAM=yes
BIRD_BATTERY_PERCENTAGE_IN_LOCKSCREEN=yes
BIRD_TP_SMART_WAKE_IN_LAUNCHER=no
BIRD_NEW_TP_SMART_WAKE=yes
BIRD_RESTORE_SETTINGS=yes
BIRD_DOUBLE_CLICK_DISMISS_HIDE_NOTICE=yes
BIRD_SETTINGS_DEVELOPMENT_HIDE=yes
BIRD_PERMISSION_NOTIFIER_HIDE=yes
BIRD_ADB_SECURE=yes
BIRD_PRODUCT_DEFAULT_OEM=bird_sz6580_6.0_SE_DS88
BIRD_PRODUCT_DEFAULT_LOCALE=en
BIRD_SYNCHRONIZE_RINGER_UI=yes
BIRD_PERMISSION_VIDEO_OPEN=yes
BIRD_HARDWARE_INFO=yes
BIRD_MMITEST_VIEW_HARDWAREINFO=yes
BIRD_AGING_TEST=yes
BIRD_ADD_SE_POLICY = yes
#BIRD_BASEBAND_VERSION = 
BIRD_KERNEL_VERSION = A1M-RV01
BUILD_FINGERPRINT = NUU/NUU_A1/NUU_A1:5.1/LMY47I/1466502365:user/release-keys
#BIRD_BUILD_NUMBER = 
BIRD_BUILD_VERNO = A1-AM-DS88-08
BIRD_EM_VERNO = A1-AM-DS88-08-20180426
BIRD_INNER_SW_VERSION = 5110DW_4080_AM.A1.$(shell date +%y%m%d).AD60.V10.WVGA.DS88.B125.MP.EN
#BIRD_EM_VERNO = 5110DW_Z403_OEM4_A.A1.161013.80M.WVGA.MY88.B125
BIRD_MCP = DS883_COMP
BIRD_MEMORYDEVICELIST_DS = DS883_COMP
